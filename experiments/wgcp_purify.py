...
try:
    ...
    from .wgcp_wavelet import (
        ...
        adaptive_multiscale_w2lite_fusion,
        dwt2_rgb_tensor,
        fuse_high_frequency,
        idwt2_rgb_tensor,
    )
...
def _reconstruct_from_prediction(
    ...
    if replacement_mode == "hard":
        ...
        ll_anchor = adaptive_meta["ll_final"]
        hf_selected = dwt2_rgb_tensor(x_rec, wavelet=wavelet)[1]
    elif replacement_mode == "adaptive_ms_w2lite":
        x_rec, adaptive_meta = adaptive_multiscale_w2lite_fusion(
            x_orig_chw=x_orig_chw,
            x_pred_chw=x_pred_chw,
            wavelet=wavelet,
            levels=ms_levels,
            gamma_text=ms_gamma_levels,
            ll_alpha=ms_ll_alpha,
            hf_mix_text=ms_w2_hf_mix_levels,
            eps=ms_eps,
            target_hw=target_hw,
        )
        ll_anchor = adaptive_meta["ll_final"]
...
def _purify_adv_tensor_global(
    ...
    ms_w2_hf_mix_levels: str = "1.0,1.0,1.0",
    ...
    x_first, first_meta = _reconstruct_from_prediction(
        ...
        ms_w2_hf_mix_levels=ms_w2_hf_mix_levels,
